...
\begin{proposition}
    ...
    \uses{def:system_of_repr_center_set,def:gkH_set_iso_kH_module,def:system_of_repr_set_center_iso_G_sigma,prop:Map_kHkG_single_apply,prop:DirectSum_eq_sum_direct}
