...
\begin{definition}[Bijectivité avec $\mathcal{H}(V*)$]
    \label{def:bij_H}
...
\begin{definition}[Antiisomorphisme avec $\mathcal{H}(V*)$]
    \label{prop:antiisoH}
    \uses{def:bij_H}
...
\begin{proposition}
    ...
    \uses{def:psi_inv_V,prop:psi_inv_Dual_comm}
