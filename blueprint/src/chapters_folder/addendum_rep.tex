...
\begin{proposition}
    ...
    \uses{def:subrep_asmodule}
    \lean{Induced_rep_center.module_sub_rep_addcommmon}
    \leanok 
   The tensor product defined in \ref{def:subrep_asmodule} is an additive commutative monoid.
\end{proposition}
\begin{proof}
    \leanok
...
\begin{proposition}
    ...
    \lean{Induced_rep_center.module_sub_rep_addcommmon}
    \leanok 
   The tensor product defined in \ref{def:subrep_asmodule} is a $\mathbb{K}[\mathcal{Z}_G]$ module.
\end{proposition}
\begin{proof}
    \leanok
    It comes from general properties of tensor products.
...
\begin{proposition}
    \label{prop:subrep_iso_theta}
    \uses{prop:subrep_module}
    \lean{Induced_rep_center.module_sub_rep_iso}
    \leanok 
   The tensor product defined in \ref{def:subrep_asmodule} is isomorphic to $V_\theta$.
\end{proposition}
\begin{proof}
    \leanok
    We consider the map \textit{mettre la map}.
\end{proof}
...
\begin{proposition}[$\mathbb{K}[\mathcal{Z}_G]\otimes_{\mathbb{K}[\mathcal{Z}_G]} V_\theta$ as submodule]
    \label{prop:center_times_theta_submodule}
    \uses{prop:center_submodule,prop:theta_submodule}
    \lean{Induced_rep_center.is_sub_rep_submodule_iso}
    \leanok 
    The image of the map sending \ref{prop:center_submodule} and \ref{prop:theta_submodule}
